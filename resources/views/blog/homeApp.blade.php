...
<div class="title">
    <h1>Blog Personal</h1>
    <a href="/singlepost" type="button" class="btn btn-icon btn-info">Previously</a>
</div>
<br>
          ...
          <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <article class="article">
              <div class="article-header">
                <div class="article-image" data-background="{{ asset('assets/img/blog/img08.png') }}">
                </div>
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <article class="article article-style-b">
              <div class="article-header">
                <div class="article-image" data-background="{{ asset('assets/img/blog/img10.png') }}">
                </div>
          ...
          <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <article class="article article-style-b">
              <div class="article-header">
                <div class="article-image" data-background="{{ asset('assets/img/blog/img15.png') }}">
                </div>
              </div>
              <div class="article-details">
                <div class="article-title">
          ...
          <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <article class="article article-style-b">
              <div class="article-header">
                <div class="article-image" data-background="{{ asset('assets/img/blog/img07.png') }}">
                </div>
              </div>
              <div class="article-details">
                <div class="article-title">
          ...
          <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <article class="article article-style-b">
              <div class="article-header">
                <div class="article-image" data-background="{{ asset('assets/img/blog/img02.png') }}">
                </div>
              </div>
              <div class="article-details">
                <div class="article-title">
        ...
        <div class="row">
          <div class="col-12 col-md-4 col-lg-4">
            <article class="article article-style-c">
              <div class="article-header">
                <div class="article-image" data-background="{{ asset('assets/img/blog/img13.png') }}">
                </div>
              </div>
              <div class="article-details">
          ...
          <div class="col-12 col-md-4 col-lg-4">
            <article class="article article-style-c">
              <div class="article-header">
                <div class="article-image" data-background="{{ asset('assets/img/blog/img14.png') }}">
                </div>
              </div>
              <div class="article-details">
                <div class="article-category"><a href="#">News</a>
          ...
          <div class="col-12 col-md-4 col-lg-4">
            <article class="article article-style-c">
              <div class="article-header">
                <div class="article-image" data-background="{{ asset('assets/img/blog/img01.png') }}">
                </div>
              </div>
              <div class="article-details">
                <div class="article-category"><a href="#">News</a>
